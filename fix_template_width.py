...
def update_table(table_name, col_name):
    ...
    <thead>
        <tr>
            <th style="width:15%; text-align:center; background-color:#1e3a5f; color:#fff; font-style:italic; padding:8px; border:1px solid #000;">CVSS Score</th>
            <th style="width:20%; text-align:center; background-color:#1e3a5f; color:#fff; font-style:italic; padding:8px; border:1px solid #000;">Severity</th>
            <th style="width:65%; background-color:#1e3a5f; color:#fff; padding:8px; border:1px solid #000;">Definition</th>
        </tr>
    </thead>
    <tbody>
        <tr>
