...
def update_table(table_name, col_name):
    ...
    <thead>
        <tr>
            <th style="text-align:center; background-color:#e50000; color:#fff; font-style:italic; padding:8px; border:1px solid #000;">CVSS Score</th>
            <th style="text-align:center; background-color:#e50000; color:#fff; font-style:italic; padding:8px; border:1px solid #000;">Severity</th>
            <th style="background-color:#e50000; color:#fff; padding:8px; border:1px solid #000;">Definition</th>
        </tr>
    </thead>
    <tbody>
        <tr>
            ...
            <td style="padding:8px; border:1px solid #000;">Peluang eksploitasi tidak ada atau tidak relevan.</td>
        </tr>
        <tr>
            ...
            <td style="padding:8px; border:1px solid #000;">Eksploitasi membutuhkan akses lokal atau interaksi pengguna yang tinggi.</td>
        </tr>
        <tr>
            ...
            <td style="padding:8px; border:1px solid #000;">Eksploitasi mungkin terjadi, namun dengan prasyarat tertentu.</td>
        </tr>
        <tr>
            ...
            <td style="padding:8px; border:1px solid #000;">Eksploitasi mudah dan sering terjadi dari jarak jauh tanpa otentikasi.</td>
        </tr>
        <tr>
            ...
            <td style="padding:8px; border:1px solid #000;">Eksploitasi sangat mudah dan biasanya menghasilkan kompromi tingkat sistem.</td>
        </tr>
    </tbody>
</table>"""
